...
} catch (e) { console.error('getBid error', e); }
try {
...
} catch (e) { console.error('_handleInterference error', e); }
try {
...
} catch (e) { console.error('_getResponseToSuit error', e); }
...
} catch (e) { console.error('getBid2 error', e); }
